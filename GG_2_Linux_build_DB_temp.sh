...
List11g=(cigfdsd cigfdst cigfdsm cigfdsp inf91d infgix8d infgix8t infgix8m infgix8p fdlzd fdlzt fdlzm trecscd trecsct trecscm trecscp obieed obieet obieem obieep obiee2d opsm opsp bpad bpat bpam bpap fnp8d fnp8t fnp8m fnp8p portalm c3appsd c3appst c3appsm c3appsp cpsmrtsm cpsmrtsp idmp p8legalp)
...
############################ RMAN 12c ASCII Duplicate Function ###############
# PURPOSE:                                                                   #
# This function runs the RMAN duplicate command for a 12c ASCII database.    #
##############################################################################
...
function duplicate_ascii_fnc {
	echo "" | tee -a $vOutputLog
	echo "Duplicating a 12c ASCII database" | tee -a $vOutputLog
...
RUN
{
  ...
  SET NEWNAME FOR DATAFILE 1  TO '/database/${vCDBFull}01/oradata/system01.dbf'; 
  SET NEWNAME FOR DATAFILE 3  TO '/database/${vCDBFull}01/oradata/sysaux01.dbf';
  SET NEWNAME FOR DATAFILE 6  TO '/database/${vCDBFull}01/oradata/users01.dbf';
  SET NEWNAME FOR DATAFILE 4  TO '/database/${vCDBFull}01/oradata/undo.dbf';
  SET NEWNAME FOR DATAFILE 8  TO '/database/${vCDBFull}01/oradata/tools01.dbf';
  SET NEWNAME FOR DATAFILE 12 TO '/database/${vCDBFull}01/oradata/LOGON_AUDIT_DATA_01.dbf';
  SET NEWNAME FOR TEMPFILE 1  TO '/database/${vCDBFull}01/oradata/temp01.dbf'; 
  SET NEWNAME FOR DATAFILE 5  TO '/database/${vCDBFull}01/oradata/pdbseed/system01.dbf';
  SET NEWNAME FOR DATAFILE 7  TO '/database/${vCDBFull}01/oradata/pdbseed/sysaux01.dbf';
  SET NEWNAME FOR DATAFILE 11 TO '/database/${vCDBFull}01/oradata/pdbseed/users01.dbf';
  SET NEWNAME FOR DATAFILE 10 TO '/database/${vCDBFull}01/oradata/pdbseed/tools01.dbf';
  SET NEWNAME FOR TEMPFILE 2  TO '/database/${vCDBFull}01/oradata/pdbseed/temp01.dbf'; 
...
############################ RMAN 12c WE8ISO8859P1 Duplicate Function ########
# PURPOSE:                                                                   #
# This function runs the RMAN duplicate command for a 12c WE8ISO8859P1       #
# database.                                                                  #
##############################################################################
...
function duplicate_we8_fnc {
	echo "" | tee -a $vOutputLog
	echo "Duplicating a 12c WE8ISO8859P1 database" | tee -a $vOutputLog
...
RUN
{
  ...
  SET NEWNAME FOR DATAFILE 1  TO '/database/${vCDBFull}01/oradata/system01.dbf'; 
  SET NEWNAME FOR DATAFILE 3  TO '/database/${vCDBFull}01/oradata/sysaux01.dbf';
  SET NEWNAME FOR DATAFILE 5  TO '/database/${vCDBFull}01/oradata/undo.dbf';
  SET NEWNAME FOR DATAFILE 6  TO '/database/${vCDBFull}01/oradata/users01.dbf';
  SET NEWNAME FOR DATAFILE 7  TO '/database/${vCDBFull}01/oradata/tools01.dbf';
  SET NEWNAME FOR DATAFILE 10 TO '/database/${vCDBFull}01/oradata/LOGON_AUDIT_DATA_01.dbf';
  SET NEWNAME FOR TEMPFILE 1  TO '/database/${vCDBFull}01/oradata/temp01.dbf'; 
  SET NEWNAME FOR DATAFILE 2  TO '/database/${vCDBFull}01/oradata/pdbseed/system01.dbf';
  SET NEWNAME FOR DATAFILE 4  TO '/database/${vCDBFull}01/oradata/pdbseed/sysaux01.dbf';
  SET NEWNAME FOR DATAFILE 8  TO '/database/${vCDBFull}01/oradata/pdbseed/tools01.dbf';
  SET NEWNAME FOR DATAFILE 9  TO '/database/${vCDBFull}01/oradata/pdbseed/users01.dbf';
  SET NEWNAME FOR TEMPFILE 2  TO '/database/${vCDBFull}01/oradata/pdbseed/temp01.dbf'; 
  DUPLICATE DATABASE $vGCSID TO $vCDBName
  BACKUP LOCATION '${vBkpLoc}/gswe8'
    LOGFILE
      GROUP 1 ('/database/${vCDBFull}_redo01/oralog/redo101.log', 
               '/database/${vCDBFull}_redo02/oralog/redo102.log') SIZE $vRedoSize REUSE, 
      GROUP 2 ('/database/${vCDBFull}_redo01/oralog/redo201.log', 
...
############################ RMAN 11g WE8ISO8859P1 Duplicate Function ########
# PURPOSE:                                                                   #
# This function runs the RMAN duplicate command for a 11g WE8ISO8859P1       #
# database.                                                                  #
##############################################################################
...
function duplicate_we8_11g_fnc {
	echo "" | tee -a $vOutputLog
	echo "Duplicating a 11g WE8ISO8859P1 database" | tee -a $vOutputLog
...
RUN
{
  ...
  DUPLICATE DATABASE $vGCSID TO $vCDBName
  BACKUP LOCATION '${vBkpLoc}/gs11we8'
    LOGFILE
      GROUP 1 ('/database/${vCDBFull}_redo01/oralog/redo101.log', 
               '/database/${vCDBFull}_redo02/oralog/redo102.log') SIZE $vRedoSize REUSE, 
      GROUP 2 ('/database/${vCDBFull}_redo01/oralog/redo201.log', 
...
RUN
{
  ...
  SET NEWNAME FOR DATAFILE 5  TO '/database/${vCDBFull}01/oradata/undo.dbf';
  SET NEWNAME FOR DATAFILE 8  TO '/database/${vCDBFull}01/oradata/tools01.dbf';
  SET NEWNAME FOR DATAFILE 13 TO '/database/${vCDBFull}01/oradata/LOGON_AUDIT_DATA_01.dbf';
  SET NEWNAME FOR TEMPFILE 1  TO '/database/${vCDBFull}01/oradata/temp01.dbf'; 
  SET NEWNAME FOR DATAFILE 2  TO '/database/${vCDBFull}01/oradata/pdbseed/system01.dbf';
  SET NEWNAME FOR DATAFILE 4  TO '/database/${vCDBFull}01/oradata/pdbseed/sysaux01.dbf';
  SET NEWNAME FOR DATAFILE 7  TO '/database/${vCDBFull}01/oradata/pdbseed/users01.dbf';
  SET NEWNAME FOR DATAFILE 12 TO '/database/${vCDBFull}01/oradata/pdbseed/tools01.dbf';
  SET NEWNAME FOR TEMPFILE 2  TO '/database/${vCDBFull}01/oradata/pdbseed/temp01.dbf'; 
  DUPLICATE DATABASE $vGCSID TO $vCDBName
  BACKUP LOCATION '${vBkpLoc}/${vGCSID}'
    LOGFILE
...
############################ RMAN 11g ASCII Duplicate Function ###############
# PURPOSE:                                                                   #
# This function runs the RMAN duplicate command for a 11g ASCII database.    #
##############################################################################
...
function duplicate_11g_ascii_fnc {
	echo "" | tee -a $vOutputLog
	echo "Duplicating an 11g ASCII database" | tee -a $vOutputLog
...
RUN
{
  ...
  ALLOCATE AUXILIARY CHANNEL c3 DEVICE TYPE DISK;
  SET NEWNAME FOR DATABASE TO '/database/${vCDBFull}01/oradata/%b';
  DUPLICATE DATABASE CIGFDSD TO $vCDBName
  BACKUP LOCATION '${vBkpLoc}/${vGCSID}'
    LOGFILE
      GROUP 1 ('/database/${vCDBFull}_redo01/oralog/redo101.log', 
               '/database/${vCDBFull}_redo02/oralog/redo102.log') SIZE $vRedoSize REUSE, 
  ...
  SPFILE
    ...
    set control_files='/database/${vCDBFull}_redo02/oractl/control02.ctl','/database/${vCDBFull}_redo01/oractl/control01.ctl'
    set diagnostic_dest='/database/${vCDBFull}_admn01/admin/'
	set log_archive_dest='/database/${vCDBFull}_arch01/arch'
    set utl_file_dir='/database/${vCDBFull}_admn01/admin/utldump/'
  NOREDO;
}
exit
...
RUNSQL
	...
	then
		vGCSID=$vGS12
		duplicate_12c_fnc
	elif [[ $vDBVersion -eq 12 && $vCharSet = US7ASCII ]]
	then
		vGCSID=$vGSASCII
		duplicate_ascii_fnc	
	elif [[ $vDBVersion -eq 12 && $vCharSet = WE8ISO8859P1 ]]
	then
		vGCSID=$vGSWE8
		duplicate_we8_fnc
		# echo "" | tee -a $vOutputLog
		# echo "There is no gold standard for version $vDBVersion using the $vCharSet character set. " | tee -a $vOutputLog
		# echo "Please use DBCA to create this database." | tee -a $vOutputLog
		# exit 1
	elif [[ $vDBVersion -eq 11 && $vCharSet = AL32UTF8 ]]
	then
		vGCSID=$vGS11
		duplicate_11g_fnc
	elif [[ $vDBVersion -eq 11 && $vCharSet = US7ASCII ]]
	then
		vGCSID=$vGS11ascii
		duplicate_11g_ascii_fnc		
	else
		vGCSID=$vGS11gWE8
		duplicate_we8_11g_fnc	
		# echo "" | tee -a $vOutputLog
		# echo "There is no gold standard for version $vDBVersion using the $vCharSet character set. " | tee -a $vOutputLog
		# echo "Please use DBCA to create this database." | tee -a $vOutputLog
		# exit 1
...
function prompt_short_fnc {
	...
	do
		...
		stty -echo
		read vGGSPwd
		echo -e "Verify the GGS password:"
		read vGGSPwdVerf
		if [[ $vGGSPwd != $vGGSPwdVerf ]]
		then
			echo -e "The passwords do not match\n"
		elif [[ -n "$vGGSPwd" ]]
		then
...
function pre_check_fnc {
	...
	# check for GG sequence script
	if [[ ! -e $vSeqScript ]]
	then
		echo ""
		echo "WARNING! - The file $vSeqScript does not exist. This may cause problems processing sequences."
		echo "           Please copy it from another server now or run it later."
	fi
...
ADMIN USER PDBADMIN IDENTIFIED BY oracle ROLES=(CONNECT)  
  file_name_convert=(
    '/database/${vCDBFull}01/oradata/pdbseed',
    '/database/${vPDBName}01/oradata'
  );
...
DATAFILE '/database/${vPDBName}01/oradata/LOGON_AUDIT_DATA_01.dbf' 
...
function import_meta_fnc {
	...
	$ORACLE_HOME/bin/sqlplus "ggs/${vGGSPwd}@(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=${vHostName}.conseco.ad)(PORT=1521))(CONNECT_DATA=(SERVICE_NAME=${vPDBName})))" << EOF
SET ECHO OFF
SET DEFINE OFF
SET ESCAPE OFF
SET FEEDBACK ON
...
function variables_fnc {
	...
	# set goldengate script name
	vSeqScript=${vScriptDir}/sequence_auto.sql
...
-- load SQL plan information from staging tables
DECLARE
	my_plans	number;
BEGIN
...
-- run GoldenGate sequence script
@$vSeqScript
